...
// Wed Jun  5 09:24:42 2024 by ROOT version 6.30/06
// from TTree Events/Events
// found on file: Zto2Q-4Jets_HT-400to600.root
//////////////////////////////////////////////////////////

#ifndef GenParticleZ_h
#define GenParticleZ_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[133];   //[nGenPart]
   UShort_t        GenPart_statusFlags[133];   //[nGenPart]
   Int_t           GenPart_pdgId[133];   //[nGenPart]
   Int_t           GenPart_status[133];   //[nGenPart]
   Float_t         GenPart_eta[133];   //[nGenPart]
   Float_t         GenPart_mass[133];   //[nGenPart]
   Float_t         GenPart_phi[133];   //[nGenPart]
   Float_t         GenPart_pt[133];   //[nGenPart]
   Int_t           nGenProton;
   Bool_t          GenProton_isPU[11];   //[nGenProton]
   Float_t         GenProton_px[11];   //[nGenProton]
   Float_t         GenProton_py[11];   //[nGenProton]
   Float_t         GenProton_pz[11];   //[nGenProton]
   Float_t         GenProton_vz[11];   //[nGenProton]
   Int_t           nSubGenJetAK8;
   ...
   Short_t         IsoTrack_charge[6];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[6];   //[nIsoTrack]
   ...
   UChar_t         Muon_mvaMuID_WP[10];   //[nMuon]
   UChar_t         Muon_nStations[10];   //[nMuon]
   UChar_t         Muon_nTrackerLayers[10];   //[nMuon]
   UChar_t         Muon_pfIsoId[10];   //[nMuon]
   UChar_t         Muon_puppiIsoId[10];   //[nMuon]
   Bool_t          Muon_softId[10];   //[nMuon]
   Bool_t          Muon_softMvaId[10];   //[nMuon]
   UChar_t         Muon_tightCharge[10];   //[nMuon]
   Bool_t          Muon_tightId[10];   //[nMuon]
   UChar_t         Muon_tkIsoId[10];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[10];   //[nMuon]
   Short_t         Muon_jetIdx[10];   //[nMuon]
   Short_t         Muon_svIdx[10];   //[nMuon]
   Short_t         Muon_fsrPhotonIdx[10];   //[nMuon]
   ...
   Float_t         Muon_bsConstrainedChi2[10];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[10];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[10];   //[nMuon]
   Float_t         Muon_mvaLowPt[10];   //[nMuon]
   Float_t         Muon_mvaTTH[10];   //[nMuon]
   Int_t           nPhoton;
   Char_t          Photon_seediEtaOriX[8];   //[nPhoton]
   UChar_t         Photon_cutBased[8];   //[nPhoton]
   Bool_t          Photon_electronVeto[8];   //[nPhoton]
   Bool_t          Photon_hasConversionTracks[8];   //[nPhoton]
   ...
   Short_t         Photon_electronIdx[8];   //[nPhoton]
   Short_t         Photon_jetIdx[8];   //[nPhoton]
   Int_t           Photon_seediPhiOriY[8];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[8];   //[nPhoton]
   Float_t         Photon_ecalPFClusterIso[8];   //[nPhoton]
   ...
   Float_t         Photon_hcalPFClusterIso[8];   //[nPhoton]
   Float_t         Photon_hoe[8];   //[nPhoton]
   Float_t         Photon_hoe_PUcorr[8];   //[nPhoton]
   Float_t         Photon_mvaID[8];   //[nPhoton]
   Float_t         Photon_pfChargedIso[8];   //[nPhoton]
   ...
   Float_t         Photon_pfRelIso03_all_quadratic[8];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg_quadratic[8];   //[nPhoton]
   ...
   Float_t         Photon_trkSumPtHollowConeDR03[8];   //[nPhoton]
   Float_t         Photon_trkSumPtSolidConeDR04[8];   //[nPhoton]
   ...
   Float_t         TkMET_sumEt;
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[63];   //[nTrigObj]
   UShort_t        TrigObj_id[63];   //[nTrigObj]
   Int_t           TrigObj_l1iso[63];   //[nTrigObj]
   Int_t           TrigObj_filterBits[63];   //[nTrigObj]
   Float_t         TrigObj_pt[63];   //[nTrigObj]
   Float_t         TrigObj_eta[63];   //[nTrigObj]
   Float_t         TrigObj_phi[63];   //[nTrigObj]
   Float_t         TrigObj_l1pt[63];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[63];   //[nTrigObj]
   Float_t         TrigObj_l2pt[63];   //[nTrigObj]
   Int_t           genTtbarId;
   Int_t           nOtherPV;
   ...
   Short_t         boostedTau_genPartIdx[3];   //[nboostedTau]
   ...
   Short_t         Muon_genPartIdx[10];   //[nMuon]
   UChar_t         Photon_genPartFlav[8];   //[nPhoton]
   Short_t         Photon_genPartIdx[8];   //[nPhoton]
   ...
   GenParticleZ(TTree *tree=0);
   virtual ~GenParticleZ();
...
#ifdef GenParticleZ_cxx
GenParticleZ::GenParticleZ(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Zto2Q-4Jets_HT-400to600.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Zto2Q-4Jets_HT-400to600.root");
      }
...
GenParticleZ::~GenParticleZ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GenParticleZ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GenParticleZ::LoadTree(Long64_t entry)
{
...
void GenParticleZ::Init(TTree *tree)
{
...
void GenParticleZ::Show(Long64_t entry)
{
...
Int_t GenParticleZ::Cut(Long64_t entry)
{
